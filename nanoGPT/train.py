...
# -----------------------------------------------------------------------------
# Parse arguments
parser = argparse.ArgumentParser(description="Training nanoGPT")
...
wandb_project = args.wandb_project # 'Advance Deep Learning Project'
...
attention_layer = args.attention_layer # CausalSelfAttention MomentumAttention AdaGradAttention RMSPropAttention AdamAttention
momentum_eta = args.momentum_eta #0.90
